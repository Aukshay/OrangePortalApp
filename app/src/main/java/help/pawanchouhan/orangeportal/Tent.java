...
public class Tent extends AppCompatActivity implements firebase_adapter_tent.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Services").child("Tent");
    ...
    public static class fatViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Log.d("got the position", String.valueOf(m));
